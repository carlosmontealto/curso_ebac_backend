...
import br.com.calto.utils.ReplaceUtils;
...
public class ClienteController implements Serializable {
  ...
  public void edit(Cliente cliente) {
    try {
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar excluir o cliente")
        );
    }
  }
  ...
  public void add() {
    try {
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar criar o cliente")
        );
    }
  }
  ...
  private void removerCaracteresInvalidos() {
    ...
    Long tel = Long.valueOf(
      ReplaceUtils.replace(getTelMask(), "(", ")", " ", "-")
    );
  ...
  public void update() {
    try {
      ...
      FacesContext
        .getCurrentInstance()
        .addMessage("growl", new FacesMessage("Cliente Atualiado com sucesso"));
    } catch (Exception e) {
      FacesContext
        .getCurrentInstance()
        .addMessage(
