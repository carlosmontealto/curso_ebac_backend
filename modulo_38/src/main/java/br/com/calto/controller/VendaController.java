package br.com.calto.controller;
...
import br.com.calto.service.IClienteService;
import br.com.calto.service.IProdutoService;
import br.com.calto.service.IVendaService;
...
public class VendaController implements Serializable {
  ...
  public void init() {
    try {
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar listar as vendas")
        );
    }
  }
  ...
  public void cancel() {
    try {
      ...
      FacesContext
        .getCurrentInstance()
        .addMessage("growl", new FacesMessage("Erro ao tentar cancelar ação"));
    }
  }
  ...
  public void edit(Venda venda) {
    try {
      ...
      this.dataVenda =
        LocalDate.ofInstant(this.venda.getDataVenda(), ZoneId.systemDefault());
      ...
      FacesContext
        .getCurrentInstance()
        .addMessage("growl", new FacesMessage("Erro ao tentar editar a venda"));
    }
  }
  ...
  public void delete(Venda venda) {
    try {
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar cancelar a venda")
        );
    }
  }
  ...
  public void finalizar(Venda venda) {
    try {
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar finalizar a venda")
        );
    }
  }
  ...
  public void add() {
    try {
      venda.setDataVenda(
        dataVenda.atStartOfDay(ZoneId.systemDefault()).toInstant()
      );
      ...
      FacesContext
        ...
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar cadastrar a venda")
        );
    }
  }
  ...
  public void update() {
    try {
      ...
      FacesContext
        .getCurrentInstance()
        .addMessage("growl", new FacesMessage("Venda atualiada com sucesso"));
    } catch (Exception e) {
      FacesContext
        .getCurrentInstance()
        .addMessage(
          "growl",
          new FacesMessage("Erro ao tentar atualizar a venda")
        );
    }
  }
  ...
  public void adicionarProduto() {
    Optional<ProdutoQuantidade> prodOp =
      this.venda.getProdutos()
        .stream()
        .filter(prodF ->
          prodF
            .getProduto()
            .getCodigo()
            .equals(this.produtoSelecionado.getCodigo())
        )
        .findFirst();
